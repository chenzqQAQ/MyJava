...
public class Drug {
     ...
     * 药品详细说明
     */
    private StringBuilder detailedDes;
    /**
     * 生产厂商
     */
    ...
    public Drug(String drugID, String drugUrl, double pruchasePrice, double sellingPrice, String drugName, int drugType, StringBuilder description, String productionDate, String overdueDate, int qualityLife, StringBuilder detailedDes, String manufacturer, String takingDes, int totalVolume, int flag, String remark) {
        this.drugID = drugID;
    ...
    public StringBuilder getDetailedDes() {
        return detailedDes;
    }

    public void setDetailedDes(StringBuilder detailedDes) {
        this.detailedDes = detailedDes;
    }
